...
Download: Kaggle — UCF Crime Mini Dataset
...
Download: Kaggle — UCA UCF Crime Annotation Dataset
Files needed:
`UCFCrime_Train.json`
`UCFCrime_Test.json`
`UCFCrime_Val.json`
...
---
📚 References
M. Abdalla and S. Javed, "Training-Free VLM-Based Pseudo Label Generation for Video Anomaly Detection", IEEE Access, vol. 13, pp. 92155–92167, 2025.
...
---
🔗 Links
📄 Paper: Abdalla & Javed (2025) — IEEE Access
📊 Mini Dataset: Kaggle — UCF Crime Mini Dataset
📝 UCA Annotations: Kaggle — UCA Dataset
🤖 CLIP Model: OpenAI CLIP
📦 Original TFPLG Code: MoshiraAbdalla/TFPLG_VAD
